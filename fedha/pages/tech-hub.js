...
export default function TechHubPage() {
  const {
    hackathons: hackathonsRaw, addHackathon, updateHackathon, removeHackathon,
  ...
  // undefined during context loading can't crash every .filter/.map call
  // throughout this file — this was the actual cause of the Events tab
  // crash (TypeError: Cannot read properties of undefined (reading
  // 'filter')): one of these was momentarily undefined when the tab
  // switch triggered a re-render.
